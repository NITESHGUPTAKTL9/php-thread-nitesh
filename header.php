  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        $sql="SELECT categariey_name, categariey_id FROM `categaries` LIMIT 3";
        $result=mysqli_query($conn,$sql);
        while($row=mysqli_fetch_assoc($result))
        { 
          echo '<a class="dropdown-item" href="threads.php?catid='.$row['categariey_id'].'">'.$row['categariey_name'].'</a>';
...
<p class="text-dark my-0 mx-2"><b> Welcome - '.$_SESSION['useremail'].'</b></p>
...
if(isset($_GET['signupsuccess']) && $_GET['signupsuccess']=="true")
{
  ...
  <strong>Success!</strong> Your account has been created <b>Successfully</b> You can <b>Login</b> now.
